...
<head>
	<title>Millersville University - Department Creation</title>
...
<?	endif;	?>
	...
	<form action="process.php" method="post">
		<div class="half">
			<h3>Name &amp; Location</h3>
			<p><label>Department Name: <input type="text" name="name" value="" size="25" /></label><br /></p>
				
			<p><label>Group Name: <input type="text" name="groupName" value="" size="25" /></label><br />
				<span class="note"><strong>Optional:</strong> If not supplied, the department name will become the group name.</span></p>
